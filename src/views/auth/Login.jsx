            ...
            <div className="flex flex-col gap-4 p-4 md:p-8">
              <div>
                ...
                <InputText
                  ...
                  name="email"
                  type="email"
                  icon={<MdAlternateEmail color="#fff" size={16} />}
                />
              </div>
              ...
              <div>
                ...
                <InputText
                  ...
                  name="password"
                  type="password"
                  icon={<RiLockPasswordLine color="#fff" size={16} />}
                />
              </div>
              ...
              <div className="flex justify-center items-center relative my-4">
                ...
                <span className="bg-white dark:bg-gray-900 text-gray-400 text-sm relative px-4">
                  lub
                </span>
              </div>
